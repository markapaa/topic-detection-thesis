...
def generate_predictions(model_suffix, model_name, limit=None):
    predictions_file = os.path.join(RESULTS_DIR, f"predictions_ablation_{model_suffix}.csv")    
    try:
    ...
    target_ids = [
        # κοινοί πίνακες (Granite, Gemma, Ministral είπαν IDK)
        'YSQ06100407I192', 'YVH06100010I27', 'HGK06100207I4082', 
        # Llama
        'LBX06100310I078', 'HGK06100207I2250', 'WPC06100307I3119', 
        # Gemma
        'HGK06100207I4132', 'WPC06100307I5443', 
        # Ministral
        'HGK06100207I2912', 'HGK06100207I1763'
    ]
    
    td_df = td_df[td_df['table_id'].astype(str).isin(target_ids)]
    print(f"Τρέχουμε στοχευμένα {len(td_df)} πίνακες για το ablation study.\n")
...
if __name__ == "__main__":
    for suffix, model in MODELS.items():
        generate_predictions(suffix, model)